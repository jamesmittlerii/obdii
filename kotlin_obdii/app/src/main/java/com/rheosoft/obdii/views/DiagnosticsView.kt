...
class DiagnosticsView(
    ...
    fun detailFor(code: TroubleCodeMetadata): DtcDetailView = DtcDetailView(code)
}

data class DiagnosticsSection(
    val header: String,
    val rows: List<DtcRowView>,
)

data class DtcRowView(
    val code: String,
    val title: String,
    val subtitle: String,
...
class DtcDetailView(private val dtc: TroubleCodeMetadata) {
...
private fun TroubleCodeMetadata.toRow(): DtcRowView = DtcRowView(
    code = code,
